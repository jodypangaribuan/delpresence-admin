...
import { registerLecture, LectureRegistrationInput } from "@/lib/auth";

export default function LectureRegisterPage() {
  const router = useRouter();
  const [formData, setFormData] = useState<LectureRegistrationInput>({
    nip: "",
    first_name: "",
    middle_name: "",
    last_name: "",
  ...
  const handleChange = (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    if (name === "email") {
      ...
      if (value && !value.endsWith("@del.ac.id")) {
        setEmailError("Email harus menggunakan domain @del.ac.id");
      } else {
        setEmailError("");
      }
    }
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (!formData.email.endsWith("@del.ac.id")) {
      setError("Email harus menggunakan domain @del.ac.id");
      return;
    }
    ...
    try {
      // Call the API for lecture registration
      await registerLecture(formData);
        ...
        <Card className="w-full max-w-md bg-white border-0 shadow-xl shadow-[#0687C9]/10 rounded-xl overflow-hidden relative">
          ...
          <div className="p-6 md:p-8 flex flex-col items-center">
            ...
            <p className="text-center text-[#64748B] mb-4">
              Akun dosen telah berhasil terdaftar. Silakan periksa email Anda
        ...
        <div className="p-6 md:p-8">
          <div className="text-center mb-8">
            ...
            <p className="mt-2 text-[#64748B] text-sm">
              Silahkan isi data berikut untuk mendaftar sebagai dosen
            </p>
          </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div className="space-y-2">
                ...
                <div className="relative">
                  <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                    <BsBriefcaseFill className="h-4 w-4 text-[#0687C9]" />
                  </div>
                  <Input
                    id="nip"
                    name="nip"
              ...
              <div className="space-y-2">
                ...
                <p className="text-xs text-gray-500 mt-1">
                  Gunakan email resmi dosen dengan domain @del.ac.id
                </p>
              </div>
